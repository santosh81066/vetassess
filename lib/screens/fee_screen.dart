              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildResponsiveTable(
                    ...
                    rows: [
                      TableRowInfo(
                        ...
                        australiaPrice: '₹66,175',
                        overseasPrice: '₹60,155',
                      ),
                      TableRowInfo(
                        label: '**Priority Processing Fee',
                        australiaPrice: '₹49,845',
                        overseasPrice: '₹45,313',
                        isLastRow: true,
                      ),
                    ],
                  ),
                  ...
                  _buildResponsiveTable(
                    ...
                    rows: [
                      TableRowInfo(
                        ...
                        australiaPrice: '₹18,799',
                        overseasPrice: '₹17,091',
                        isLastRow: true,
                      ),
                    ],
                  ),
                  ...
                  _buildResponsiveTable(
                    ...
                    rows: [
                      TableRowInfo(
                        ...
                        australiaPrice: '₹65,332',
                        overseasPrice: '₹59,425',
                        isLastRow: true,
                      ),
                    ],
                  ),
                  ...
                  _buildResponsiveTable(
                    ...
                    rows: [
                      TableRowInfo(
                        ...
                        australiaPrice: '₹28,571',
                        overseasPrice: '₹25,974',
                      ),
                      TableRowInfo(
                  ...
                  _buildStandardSection(context, 'Other Information', [
                    ...
                    const SizedBox(height: 20),
                    const Text(
                      'You may request to reopen an application after providing all required documents and information within 90 days of closure. A fee of ₹9,389 will apply. Requests received after 90 days will not be accepted and you will need to lodge a new application and pay the full assessment fee.',
                    ...
                    _buildBulletPoints('In Indian Rupees (INR)'),
                    const SizedBox(height: 10),
                    _buildBulletPoints(
      ...
      TableRow(
        ...
        children: [
          ...
          _buildResponsiveHeaderCell(
            isMobile
                ? 'India\n(inc. GST)'
                : 'Applying from within India (includes GST)',
            isMobile,
            isTablet,
          ),
          _buildResponsiveHeaderCell(
            isMobile
                ? 'Overseas\n(exc. GST)'
                : 'Applicant is not a resident of India for tax purposes (excludes GST)',
            isMobile,
            isTablet,
          ),
        ],
