...
class UploadProvider extends StateNotifier<UploadModel> {
  ...
  Future<Map<String, dynamic>> uploadFile({
    ...
    try {
      const String url = VetassessApi.form_upload_doc;
      ...
      if (kIsWeb) {
        ...
        if (platformFile != null && platformFile.bytes != null) {
          ...
          print(
            'File added (Web): ${platformFile.name}, Size: ${platformFile.bytes!.length} bytes',
          );
        }
      } else {
        ...
        if (file != null) {
          ...
          print(
            'File added (Mobile): $fileName, Size: ${fileBytes.length} bytes',
          );
        }
      }
...
final uploadProvider = StateNotifierProvider<UploadProvider, UploadModel>((
  ref,
) {
