...
static Future<void> downloadadminCertificate(
  BuildContext context,
  WidgetRef ref,
  int? userId, // changed from `Users user`
) async {
  try {
    final url = 'https://vetassess.com.co/user/certificate/$userId';
